...
export default function OverviewPage() {
  ...
  // Test contract addresses (you can replace these with real ones)
  const TEST_TOKEN_ADDRESS = "0x5FbDB2315678afecb367f032d93F642f64180aa3"; // Example USDT
  const TEST_SPENDER_ADDRESS = "0xe7f1725E7734CE288F8367e1Bb143E90bb3F0512"; // Example spender
  ...
  const handleApproveMax = async () => {
    ...
    try {
      ...
      // Check if on Localhost (Hardhat)
      const chainId = Number(network.chainId);
      if (chainId !== 31337 && chainId !== 1337) {
        toast.error('Wrong network', {
          id: loadingToast,
          description: 'Please switch your MetaMask to Localhost 8545 to test transactions.'
        });
      ...
      console.log('Requesting approval for:', TEST_SPENDER_ADDRESS);

      // Attempt transaction
      const tx = await tokenContract.approve(TEST_SPENDER_ADDRESS, ethers.MaxUint256);
              ...
              <div className="p-4 bg-gray-900 rounded-lg border border-gray-700">
                ...
                <div className="mt-3 flex items-center justify-between">
                  <p className="text-[10px] text-gray-500 uppercase tracking-wider font-bold">
                    Target: Hardhat Localhost
                  </p>
                  <Button
                    variant="ghost"
                    size="sm"
                    className="h-6 text-[10px] bg-gray-800 hover:bg-gray-700 text-blue-400"
                    onClick={() => {
